...
class Read_Bar_Settings {
    ...
    public function rb_bar_shadow_cb() {
        ...
        <div class="switch_wrapper">
            ...
            <label class="switch" for="rb-bar-shadow"></label>        
        </div>    
        <?php
    }
    ...
    public function rb_bar_rounded_cb() {
        ...
        <div class="switch_wrapper display_on">
            ...
            <label class="switch" for="rb-bar-rounded"></label>                    
        </div>        
        <?php
    } 
    ...
    public function rb_bar_placement_cb() {
        ...
        <div class="placement_wrapper">
            <input type="radio" id="top" class="bar-placement-option" name="rb_bar_placement_cb" value="top" <?php checked('top', esc_attr($this->bar_placement), true); ?>>            
            <input type="radio" id="bottom" class="bar-placement-option" name="rb_bar_placement_cb" value="bottom" <?php checked('bottom', esc_attr($this->bar_placement), true); ?>>            
            <label for="top" class="bar-placement-label top-align">
                <span></span>
            </label>          
            <label for="bottom" class="placement-label bottom-align">
                <span></span>
            </label>           
        </div>
        <?php
    ...
    public function rb_bar_height_cb() {       
        ?>
        <div class="range_slider-wrapper slider-height">
    ...
    public function rb_display_on_cb() {    
        ...
        <div class="switch_wrapper display_on">
            ...
            <label class="switch" for="rb_show_home_page"></label>        
        ...
        <div class="switch_wrapper display_on">
            ...
            <label class="switch" for="rb_show_single_post"></label>
            <div class="switch_label">                    
        ...
        <div class="switch_wrapper display_on">
            ...
            <label class="switch" for="rb_show_single_page"><span></label>        
            <div class="switch_label">            
        ...
        <div class="switch_wrapper display_on">
            ...
            <label class="switch" for="rb_show_archive"></label>        
            <div class="switch_label">            
